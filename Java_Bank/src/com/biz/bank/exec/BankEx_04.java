...
public class BankEx_04 {
	public static void main(String[] args) {
		...
		while (true) {
			 ...
			 * 호출하여 어떤 행동을 수행해야할 필요가 있을 때가 있다.
			 * 
			 * 객체를 선언할때 interface로 선언을 하면 클래스에 구현된 method를 직접 호출하는 것이 안된다. 이럴 때 down
			 * Casting을 해서 해당 method를 사용할 수 있다.
			 */

			// interface에 설정되지 않은 V4에만 있는 method를 호출하는 방법
			// down Casting
