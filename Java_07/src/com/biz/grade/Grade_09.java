...
public class Grade_09 {
	...
	public static void main(String[] args) {
		...
		for(int i = 1; i <= 2; i++) {
			 ...
			 * 아래와 같이 사용하면 num_1 = 90 이라는 코드로 바뀌어 사용할 수 있을 것 같지만
			 * 문법상 이 코드는 num_i라는 변수를 찾는 코드로 변환되어 syntax오류를 발생한다.
			 * 이러한 코드는 사용이 불가능하다.
			 */
			//num_i = 90;
		}
		
		// 정수 값을 저장할 배열 100개를 생성하라(선언과 초기화를 동시에 수행)
		int[] intKorScore = new int[100];
		
		// 배열 100개에 임의 정수 51 ~ 100 까지 값을 채워넣기
