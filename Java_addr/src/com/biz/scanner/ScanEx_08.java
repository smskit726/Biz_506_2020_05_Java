...
public class ScanEx_08 {
	public static void main(String[] args) {
		...
		System.out.println("■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■■");
		System.out.println("1. 학생정보입력 처리");
		...
		// Exception Handling
		// Exception이 발생할 가능성이 1/100만 이라도 있으면 try-catch 문을 사용하여 Handling(처리) 수행하여
		...
		try {
			...
			System.out.println("업무 선택은 숫자 1 ~ 3 또는 -1 만 가능!!");
