...
public class String01 {
	public static void main(String[] args) {
		...
		/*
		 * 문자열형 변수는
		 * 변수가 생성될 때 실제 문자열이 담기는 변수영역과 문자열이 담긴 변수 영역의 주소를 갖고 있는 변수 영역 이렇게 2개가 생성된다.
		 * 한 곳은 실제 값이 담기고, 한곳은 주소가 담긴다.
		 * 
		 * 문자열을 == 비교연산자로 비교를 하면
		 * 원칙은 주소로 비교를 하나, 어떤 때는 문자열 값으로 비교하기도 하고 어떤 때는 주소로 비교를 한다.
		 * 
