...
public class ClassEx_13 {
	public static void main(String[] args) {
		...
		long num1 = 0L; // long형 변수 num1를 선언하고 0으로 clear
		float num2 = 0.0f;
		double num3 = 0.0;
		boolean bYes = false;
		char char1= 'c'; // character형 변수 char1를 선언하고 문자 'c'를 저장
		
		// String(문자열)형 변수는 변수처럼 사용하지만 실제로는 일반변수와 달리 String 클래스로 만든 String형 인스턴스라고 해야한다.
		String strName = "홍길동";
		...
		// bankServiceV2 클래스내에 정의된 bankList() method 내의 코드들이 순서대로 실행된다.
