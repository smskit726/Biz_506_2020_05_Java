...
public class Grade_02 {
	public static void main(String[] args) {
		...
		*/
		...
		/*
		 * 배열을 선언할 때 보관할 값의 개수가 얼마인지 확시치 않을 때 배열을 빈(Blank) 크기만큼만 선언하고
		 * {}; 를 사용하여  값을 미리 저장하는 방법
		 * 이 방법을 사용하면, 배열의 개수가 변동될 때 배열에 저장되는 값을 추가, 삭제함으로서 자동으로 배열이 생성된다.
		 * 
		...
		// score
		// int[][] score : score 배열을 가로 세로 방향으로 선언하겠다.
		// 2차원 배열, Table Array
		...
		/*
		 * 배열.length : 배열의 개수가 몇개인지 알려주는 키워드변수, 필드변수, 멤버변수
		 * 배열의 개수가 궁금할때 일일이 세어보지 않아도 알 수 있게 해주는 키워드변수이다.
		 */
